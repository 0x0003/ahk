...
#Space::
  ...
  run,  C:\Users\%A_Username%\scoop\apps\alacritty\current\alacritty.exe --config-file C:\Users\%A_Username%\scoop\persist\alacritty\alacritty.toml --command wsl, \\wsl.localhost\Arch\home\%A_Username% ,,PID
  WinWait ahk_pid %PID%
  Sleep, 300
...
^#Space::
  ...
  run,  C:\Users\%A_Username%\scoop\apps\alacritty\current\alacritty.exe --config-file C:\Users\%A_Username%\scoop\persist\alacritty\alacritty.toml, C:\Users\%A_Username%
return
