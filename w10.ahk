...
#Space::
  ...
  run,  D:\Scoop\apps\alacritty\current\alacritty.exe --config-file D:\Scoop\persist\alacritty\alacritty.toml --command wsl, \\wsl.localhost\Arch\home\tuna,,PID
  WinWait ahk_pid %PID%
  Sleep, 300
...
^#Space::
  ...
  run,  D:\Scoop\apps\alacritty\current\alacritty.exe --config-file D:\Scoop\persist\alacritty\alacritty.toml, C:\Users\%A_Username%
return
